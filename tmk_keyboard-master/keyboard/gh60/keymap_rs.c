...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
     ...
     * |-----------------------------------------------------------|
     * |     |   |Up|Caps|PrSn|   |Hom|PgD|PgU|End|Ins|   |   |    |
     * |-----------------------------------------------------------|
     * |      |Lef|Dow|Rig|Delt|  |Lef|Dow|Up |Rig|   |VolU|       |
     * |-----------------------------------------------------------|
     * |        |   |   |   |Fn2|Fn3|   |   |   |Mute|VolD|    |   |
     * |-----------------------------------------------------------|
     * |    |    |    |                        |McR |    |    |    |
    ...
    KEYMAP_ANSI(
        ...
        TRNS,TRNS,UP,  CAPS,PSCR,TRNS,HOME,PGDN,PGUP, END,INS,TRNS,TRNS,TRNS, \
        TRNS,LEFT,DOWN,RGHT,DEL,TRNS,LEFT,DOWN,UP,RGHT,TRNS, VOLU,      TRNS, \
        TRNS,     TRNS,TRNS, TRNS, FN2, FN3, TRNS,TRNS,TRNS,MUTE,VOLD,    TRNS, \
        TRNS,TRNS,TRNS,          TRNS,                    BTN2,TRNS,TRNS,TRNS),
};
